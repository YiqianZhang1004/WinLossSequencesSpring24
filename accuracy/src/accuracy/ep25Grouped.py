...
for i in range(len(grouped_seasons)):
    ...
    elo_rate = accuracyFunction.getAccuracy("e", groupedList, [],[], [], top25, top25,'','','','')
    poll_rate = accuracyFunction.getAccuracy("p", groupedList,[], [], [], top25, top25,'','','','')
...
plt.savefig('accuracy/visualizations/ep25Grouped.png')
plt.show()


with open("accuracy/visualization_data/ep25Grouped.csv", 'w', newline='') as file:
