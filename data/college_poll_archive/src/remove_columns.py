...
cfb = pd.read_csv("data/college_poll_archive/raw_data/combined_cfb_poll_data.csv")
cbb = pd.read_csv("data/college_poll_archive/raw_data/combined_cbb_poll_data.csv")
...
cfb.to_csv("data/college_poll_archive/processed_data/cfb_polls_trim.csv")
cbb.to_csv("data/college_poll_archive/processed_data/cbb_polls_trim.csv")