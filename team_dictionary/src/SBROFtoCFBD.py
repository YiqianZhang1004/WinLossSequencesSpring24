...
with open("cfbd/processed_data/cfbd.csv", "r") as file:
...
with open("sportsbookreviewsonline/ncaaf/processsed_data/sbro_ncaaf.csv", "r") as file:
    games = csv.DictReader(file)
    for game in games:
...
with open("team_dictionary/processed_data/SBROtoCFBD.json", 'w') as json_file:
